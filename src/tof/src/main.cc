...
#define ser (*pser)
 ...
 public:
  SipeedTOF_MSA010_Publisher() : Node("tof") {
    std::string s;
    this->declare_parameter("device", "/dev/tof_USB");
    ...
    // std::cout << "AT+COEFF=1 OK" << std::endl;
 ...
 private:
  ...
  _more:
    ...
    std::cout << "Publishing depth done"<< std::endl;
    ...
    std::cout << "Publishing cloud done"<< std::endl;
